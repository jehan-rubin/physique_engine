...
short int core___core__Collection___has_only(val* self, val* p0) {
short int var /* : Bool */;
val* var_item /* var item: nullable Object */;
val* var_ /* var : Collection[nullable Object] */;
val* var1 /* : Iterator[nullable Object] */;
...
var6 = ((short int(*)(val* self, val* p0))((((long)var_i&3)?class_info[((long)var_i&3)]:var_i->class)->vft[COLOR_core__kernel__Object___33d_61d]))(var_i, var_item); /* != on <var_i:nullable Object>*/
var5 = var6;
}
if (var5){
var = 0;
...
/* method abstract_collection#Collection#has_any for (self: Collection[nullable Object], Collection[nullable Object]): Bool */
short int core___core__Collection___has_any(val* self, val* p0) {
short int var /* : Bool */;
val* var_other /* var other: Collection[nullable Object] */;
val* var_ /* var : Collection[nullable Object] */;
val* var1 /* : Iterator[nullable Object] */;
...
var_o = var4;
{
var5 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var_o); /* has on <self:Collection[nullable Object]>*/
}
if (var5){
var = 1;
goto RET_LABEL;
...
val* core___core__Iterator___item(val* self) {
val* var /* : nullable Object */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "item", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 207);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#Iterator#next for (self: Iterator[nullable Object]) */
void core___core__Iterator___next(val* self) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "next", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 211);
fatal_exit(1);
RET_LABEL:;
}
/* method abstract_collection#Iterator#next_by for (self: Iterator[nullable Object], Int) */
void core___core__Iterator___next_by(val* self, long p0) {
...
if (unlikely(!var)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 239);
fatal_exit(1);
}
for(;;) {
{
var5 = ((short int(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Iterator__is_ok]))(self); /* is_ok on <self:Iterator[nullable Object]>*/
}
var_ = var5;
if (var5){
{
...
short int core___core__Iterator___is_ok(val* self) {
short int var /* : Bool */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "is_ok", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 246);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
/* method abstract_collection#Iterator#start for (self: Iterator[nullable Object]) */
void core___core__Iterator___start(val* self) {
RET_LABEL:;
}
...
/* method abstract_collection#Iterator#to_step for (self: Iterator[nullable Object], Int): Iterator[nullable Object] */
val* core___core__Iterator___to_step(val* self, long p0) {
val* var /* : Iterator[nullable Object] */;
long var_step /* var step: Int */;
val* var1 /* : StepIterator[nullable Object] */;
var_step = p0;
var1 = NEW_core__abstract_collection__StepIterator((((long)self&3)?type_info[((long)self&3)]:self->type)->resolution_table->types[COLOR_core__abstract_collection__StepIterator__core__Iterator___35dE]);
{
((void(*)(val* self, val* p0))(var1->class->vft[COLOR_core__abstract_collection__IteratorDecorator__real_61d]))(var1, self); /* real= on <var1:StepIterator[nullable Object]>*/
}
{
((void(*)(val* self, long p0))(var1->class->vft[COLOR_core__abstract_collection__StepIterator__step_61d]))(var1, var_step); /* step= on <var1:StepIterator[nullable Object]>*/
}
{
((void(*)(val* self))(var1->class->vft[COLOR_core__kernel__Object__init]))(var1); /* init on <var1:StepIterator[nullable Object]>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method abstract_collection#IteratorDecorator#real for (self: IteratorDecorator[nullable Object]): Iterator[nullable Object] */
val* core___core__IteratorDecorator___real(val* self) {
val* var /* : Iterator[nullable Object] */;
val* var1 /* : Iterator[nullable Object] */;
var1 = self->attrs[COLOR_core__abstract_collection__IteratorDecorator___real].val; /* _real on <self:IteratorDecorator[nullable Object]> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _real");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 291);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
/* method abstract_collection#IteratorDecorator#real= for (self: IteratorDecorator[nullable Object], Iterator[nullable Object]) */
void core___core__IteratorDecorator___real_61d(val* self, val* p0) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
const char* var_class_name;
/* Covariant cast for argument 0 (real) <p0:Iterator[nullable Object]> isa Iterator[E] */
/* <p0:Iterator[nullable Object]> isa Iterator[E] */
type_struct = self->type->resolution_table->types[COLOR_core__Iterator__core__IteratorDecorator___35dE];
...
self->attrs[COLOR_core__abstract_collection__IteratorDecorator___real].val = p0; /* _real on <self:IteratorDecorator[nullable Object]> */
RET_LABEL:;
}
/* method abstract_collection#IteratorDecorator#is_ok for (self: IteratorDecorator[nullable Object]): Bool */
short int core___core__IteratorDecorator___Iterator__is_ok(val* self) {
short int var /* : Bool */;
val* var1 /* : Iterator[nullable Object] */;
short int var2 /* : Bool */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__IteratorDecorator__real]))(self); /* real on <self:IteratorDecorator[nullable Object]>*/
}
{
...
/* method abstract_collection#IteratorDecorator#item for (self: IteratorDecorator[nullable Object]): nullable Object */
val* core___core__IteratorDecorator___Iterator__item(val* self) {
val* var /* : nullable Object */;
val* var1 /* : Iterator[nullable Object] */;
...
/* method abstract_collection#IteratorDecorator#finish for (self: IteratorDecorator[nullable Object]) */
void core___core__IteratorDecorator___Iterator__finish(val* self) {
val* var /* : Iterator[nullable Object] */;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__IteratorDecorator__real]))(self); /* real on <self:IteratorDecorator[nullable Object]>*/
}
{
((void(*)(val* self))((((long)var&3)?class_info[((long)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__finish]))(var); /* finish on <var:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#IteratorDecorator#next for (self: IteratorDecorator[nullable Object]) */
void core___core__IteratorDecorator___Iterator__next(val* self) {
val* var /* : Iterator[nullable Object] */;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__IteratorDecorator__real]))(self); /* real on <self:IteratorDecorator[nullable Object]>*/
}
...
/* method abstract_collection#IteratorDecorator#next_by for (self: IteratorDecorator[nullable Object], Int) */
void core___core__IteratorDecorator___Iterator__next_by(val* self, long p0) {
long var_step /* var step: Int */;
val* var /* : Iterator[nullable Object] */;
var_step = p0;
{
...
{
((void(*)(val* self, long p0))((((long)var&3)?class_info[((long)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__next_by]))(var, var_step); /* next_by on <var:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#IteratorDecorator#init for (self: IteratorDecorator[nullable Object]) */
void core___core__IteratorDecorator___core__kernel__Object__init(val* self) {
{
((void(*)(val* self))(self->class->vft[COLOR_core___core__IteratorDecorator___core__kernel__Object__init]))(self); /* init on <self:IteratorDecorator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#StepIterator#step for (self: StepIterator[nullable Object]): Int */
long core__abstract_collection___core__abstract_collection__StepIterator___step(val* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = self->attrs[COLOR_core__abstract_collection__StepIterator___step].l; /* _step on <self:StepIterator[nullable Object]> */
var = var1;
RET_LABEL:;
return var;
}
/* method abstract_collection#StepIterator#step= for (self: StepIterator[nullable Object], Int) */
void core__abstract_collection___core__abstract_collection__StepIterator___step_61d(val* self, long p0) {
self->attrs[COLOR_core__abstract_collection__StepIterator___step].l = p0; /* _step on <self:StepIterator[nullable Object]> */
RET_LABEL:;
}
/* method abstract_collection#StepIterator#next for (self: StepIterator[nullable Object]) */
void core__abstract_collection___core__abstract_collection__StepIterator___Iterator__next(val* self) {
val* var /* : Iterator[nullable Object] */;
long var1 /* : Int */;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__IteratorDecorator__real]))(self); /* real on <self:StepIterator[nullable Object]>*/
}
{
var1 = ((long(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__StepIterator__step]))(self); /* step on <self:StepIterator[nullable Object]>*/
}
{
((void(*)(val* self, long p0))((((long)var&3)?class_info[((long)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__next_by]))(var, var1); /* next_by on <var:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#StepIterator#next_by for (self: StepIterator[nullable Object], Int) */
void core__abstract_collection___core__abstract_collection__StepIterator___Iterator__next_by(val* self, long p0) {
long var_step /* var step: Int */;
val* var /* : Iterator[nullable Object] */;
long var1 /* : Int */;
long var2 /* : Int */;
...
{
{ /* Inline kernel#Int#* (var_step,var1) on <var_step:Int> */
...
{
((void(*)(val* self, long p0))((((long)var&3)?class_info[((long)var&3)]:var->class)->vft[COLOR_core__abstract_collection__Iterator__next_by]))(var, var2); /* next_by on <var:Iterator[nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#StepIterator#init for (self: StepIterator[nullable Object]) */
void core__abstract_collection___core__abstract_collection__StepIterator___core__kernel__Object__init(val* self) {
{
((void(*)(val* self))(self->class->vft[COLOR_core__abstract_collection___core__abstract_collection__StepIterator___core__kernel__Object__init]))(self); /* init on <self:StepIterator[nullable Object]>*/
}
RET_LABEL:;
}
...
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__Ref__item]))(self); /* item on <self:Ref[nullable Object]>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
if (var1 == NULL) {
var2 = (var_an_item == NULL);
} else {
var3 = ((short int(*)(val* self, val* p0))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__kernel__Object___61d_61d]))(var1, var_an_item); /* == on <var1:nullable Object>*/
var2 = var3;
}
var = var2;
goto RET_LABEL;
...
/* method abstract_collection#Ref#has_only for (self: Ref[nullable Object], nullable Object): Bool */
short int core___core__Ref___Collection__has_only(val* self, val* p0) {
short int var /* : Bool */;
val* var_an_item /* var an_item: nullable Object */;
val* var1 /* : nullable Object */;
short int var2 /* : Bool */;
...
{
var2 = ((val*(*)(val* self))(var1->class->vft[COLOR_core__abstract_collection__Ref__item]))(var1); /* item on <var1:Ref[nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
{
((void(*)(val* self, short int p0))(self->class->vft[COLOR_core__abstract_collection__RefIterator__is_ok_61d]))(self, 0); /* is_ok= on <self:RefIterator[nullable Object]>*/
}
RET_LABEL:;
}
...
val* core__abstract_collection___core__abstract_collection__RefIterator___container(val* self) {
val* var /* : Ref[nullable Object] */;
val* var1 /* : Ref[nullable Object] */;
var1 = self->attrs[COLOR_core__abstract_collection__RefIterator___container].val; /* _container on <self:RefIterator[nullable Object]> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _container");
...
void core___core__RemovableCollection___remove_all(val* self, val* p0) {
val* var_item /* var item: nullable Object */;
short int var /* : Bool */;
var_item = p0;
for(;;) {
{
var = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var_item); /* has on <self:RemovableCollection[nullable Object]>*/
}
if (var){
{
((void(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__RemovableCollection__remove]))(self, var_item); /* remove on <self:RemovableCollection[nullable Object]>*/
}
} else {
goto BREAK_label;
}
...
short int core___core__Set___Collection__has_only(val* self, val* p0) {
short int var /* : Bool */;
val* var_item /* var item: nullable Object */;
long var1 /* : Int */;
long var_l /* var l: Int */;
...
if (var2){
{
var5 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has]))(self, var_item); /* has on <self:Set[nullable Object]>*/
}
var = var5;
goto RET_LABEL;
} else {
...
void core___core__Set___RemovableCollection__remove_all(val* self, val* p0) {
val* var_item /* var item: nullable Object */;
var_item = p0;
{
((void(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__RemovableCollection__remove]))(self, var_item); /* remove on <self:Set[nullable Object]>*/
}
RET_LABEL:;
}
...
{
var9 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__has_all]))(self, var_other); /* has_all on <self:Set[nullable Object]>*/
}
var = var9;
goto RET_LABEL;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 460);
fatal_exit(1);
} else {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 464);
fatal_exit(1);
}
var_other = p0;
{
...
var_nhs = var2;
{
((void(*)(val* self, val* p0))((((long)var_nhs&3)?class_info[((long)var_nhs&3)]:var_nhs->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add_all]))(var_nhs, self); /* add_all on <var_nhs:Set[nullable Object]>*/
}
{
((void(*)(val* self, val* p0))((((long)var_nhs&3)?class_info[((long)var_nhs&3)]:var_nhs->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add_all]))(var_nhs, var_other); /* add_all on <var_nhs:Set[nullable Object]>*/
}
var = var_nhs;
goto RET_LABEL;
RET_LABEL:;
...
val* core___core__Set___intersection(val* self, val* p0) {
val* var /* : Set[nullable Object] */;
short int var1 /* : Bool */;
int cltype;
int idtype;
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Set[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 473);
fatal_exit(1);
}
var_other = p0;
{
...
var_ = self;
{
var3 = ((val*(*)(val* self))((((long)var_&3)?class_info[((long)var_&3)]:var_->class)->vft[COLOR_core__abstract_collection__Collection__iterator]))(var_); /* iterator on <var_:Set[nullable Object]>*/
}
var_4 = var3;
for(;;) {
{
...
var_v = var6;
{
var7 = ((short int(*)(val* self, val* p0))((((long)var_other&3)?class_info[((long)var_other&3)]:var_other->class)->vft[COLOR_core__abstract_collection__Collection__has]))(var_other, var_v); /* has on <var_other:Set[nullable Object]>*/
}
if (var7){
{
((void(*)(val* self, val* p0))((((long)var_nhs&3)?class_info[((long)var_nhs&3)]:var_nhs->class)->vft[COLOR_core__abstract_collection__SimpleCollection__add]))(var_nhs, var_v); /* add on <var_nhs:Set[nullable Object]>*/
}
} else {
}
{
...
const char* var_class_name;
{
var1 = ((val*(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Set__union]))(self, self); /* union on <self:Set[nullable Object]>*/
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 481);
fatal_exit(1);
}
var = var1;
goto RET_LABEL;
...
val* core___core__MapRead____91d_93d(val* self, val* p0) {
val* var /* : nullable Object */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 492);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
val* core___core__MapRead___get_or_default(val* self, val* p0, val* p1) {
val* var /* : nullable Object */;
short int var1 /* : Bool */;
int cltype;
int idtype;
...
type_struct = (((long)self&3)?type_info[((long)self&3)]:self->type)->resolution_table->types[COLOR_core__MapRead___35dV];
cltype = type_struct->color;
idtype = type_struct->id;
is_nullable = type_struct->is_nullable;
if(p1 == NULL) {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 517);
fatal_exit(1);
}
var_key = p0;
var_default = p1;
{
var2 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__has_key]))(self, var_key); /* has_key on <self:MapRead[nullable Object, nullable Object]>*/
}
if (var2){
{
var3 = ((val*(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead___91d_93d]))(self, var_key); /* [] on <self:MapRead[nullable Object, nullable Object]>*/
}
var = var3;
goto RET_LABEL;
} else {
...
short int core___core__MapRead___has_key(val* self, val* p0) {
short int var /* : Bool */;
val* var_key /* var key: nullable Object */;
...
var_key = p0;
{
var1 = ((val*(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__keys]))(self); /* keys on <self:MapRead[nullable Object, nullable Object]>*/
}
{
var2 = ((short int(*)(val* self, val* p0))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Collection__has]))(var1, var_key); /* has on <var1:Collection[nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
val* core___core__MapRead___iterator(val* self) {
val* var /* : MapIterator[nullable Object, nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "iterator", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 540);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapRead#values for (self: MapRead[nullable Object, nullable Object]): Collection[nullable Object] */
val* core___core__MapRead___values(val* self) {
val* var /* : Collection[nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "values", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 543);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapRead#keys for (self: MapRead[nullable Object, nullable Object]): Collection[nullable Object] */
val* core___core__MapRead___keys(val* self) {
val* var /* : Collection[nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "keys", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 553);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapRead#is_empty for (self: MapRead[nullable Object, nullable Object]): Bool */
short int core___core__MapRead___is_empty(val* self) {
short int var /* : Bool */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "is_empty", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 563);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapRead#not_empty for (self: MapRead[nullable Object, nullable Object]): Bool */
short int core___core__MapRead___not_empty(val* self) {
short int var /* : Bool */;
short int var1 /* : Bool */;
short int var2 /* : Bool */;
{
var1 = ((short int(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__is_empty]))(self); /* is_empty on <self:MapRead[nullable Object, nullable Object]>*/
}
var2 = !var1;
var = var2;
goto RET_LABEL;
...
long core___core__MapRead___length(val* self) {
long var /* : Int */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "length", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 581);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 596);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
BREAK_label: (void)0;
{
((void(*)(val* self))((((long)var_10&3)?class_info[((long)var_10&3)]:var_10->class)->vft[COLOR_core__abstract_collection__MapIterator__finish]))(var_10); /* finish on <var_10:MapIterator[nullable Object, nullable Object]>*/
}
var = 1;
goto RET_LABEL;
RET_LABEL:;
...
BREAK_label: (void)0;
{
((void(*)(val* self))((((long)var_3&3)?class_info[((long)var_3&3)]:var_3->class)->vft[COLOR_core__abstract_collection__MapIterator__finish]))(var_3); /* finish on <var_3:MapIterator[nullable Object, nullable Object]>*/
}
var = var_res;
goto RET_LABEL;
RET_LABEL:;
...
void core___core__Map____91d_93d_61d(val* self, val* p0, val* p1) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]=", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 669);
fatal_exit(1);
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 686);
fatal_exit(1);
}
var_map = p0;
{
...
void core___core__Map___recover_with(val* self, val* p0) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "MapRead[K, V]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 708);
fatal_exit(1);
}
var_map = p0;
{
((void(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Map__add_all]))(self, var_map); /* add_all on <self:Map[nullable Object, nullable Object]>*/
}
RET_LABEL:;
}
/* method abstract_collection#Map#clear for (self: Map[nullable Object, nullable Object]) */
void core___core__Map___clear(val* self) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "clear", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 711);
fatal_exit(1);
RET_LABEL:;
}
/* method abstract_collection#Map#values for (self: Map[nullable Object, nullable Object]): RemovableCollection[nullable Object] */
val* core___core__Map___MapRead__values(val* self) {
val* var /* : RemovableCollection[nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "values", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 721);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#Map#keys for (self: Map[nullable Object, nullable Object]): RemovableCollection[nullable Object] */
val* core___core__Map___MapRead__keys(val* self) {
val* var /* : RemovableCollection[nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "keys", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 723);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapIterator#item for (self: MapIterator[nullable Object, nullable Object]): nullable Object */
val* core___core__MapIterator___item(val* self) {
val* var /* : nullable Object */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "item", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 728);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapIterator#key for (self: MapIterator[nullable Object, nullable Object]): nullable Object */
val* core___core__MapIterator___key(val* self) {
val* var /* : nullable Object */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "key", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 732);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapIterator#next for (self: MapIterator[nullable Object, nullable Object]) */
void core___core__MapIterator___next(val* self) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "next", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 736);
fatal_exit(1);
RET_LABEL:;
}
/* method abstract_collection#MapIterator#is_ok for (self: MapIterator[nullable Object, nullable Object]): Bool */
short int core___core__MapIterator___is_ok(val* self) {
short int var /* : Bool */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "is_ok", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 740);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#MapIterator#start for (self: MapIterator[nullable Object, nullable Object]) */
void core___core__MapIterator___start(val* self) {
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 770);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
short int var2 /* : Bool */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__MapKeysIterator__original_iterator]))(self); /* original_iterator on <self:MapKeysIterator[nullable Object, nullable Object]>*/
}
{
var2 = ((short int(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var1); /* is_ok on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
val* var /* : MapIterator[nullable Object, nullable Object] */;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__MapKeysIterator__original_iterator]))(self); /* original_iterator on <self:MapKeysIterator[nullable Object, nullable Object]>*/
}
{
...
{
var2 = ((val*(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__key]))(var1); /* key on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _original_iterator");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 781);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
short int var2 /* : Bool */;
{
var1 = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__MapValuesIterator__original_iterator]))(self); /* original_iterator on <self:MapValuesIterator[nullable Object, nullable Object]>*/
}
{
var2 = ((short int(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__is_ok]))(var1); /* is_ok on <var1:MapIterator[nullable Object, nullable Object]>*/
}
...
val* var /* : MapIterator[nullable Object, nullable Object] */;
{
var = ((val*(*)(val* self))(self->class->vft[COLOR_core__abstract_collection__MapValuesIterator__original_iterator]))(self); /* original_iterator on <self:MapValuesIterator[nullable Object, nullable Object]>*/
}
{
((void(*)(val* self))((((long)var&3)?class_info[((long)var&3)]:var->class)->vft[COLOR_core__abstract_collection__MapIterator__next]))(var); /* next on <var:MapIterator[nullable Object, nullable Object]>*/
}
...
{
var2 = ((val*(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__MapIterator__item]))(var1); /* item on <var1:MapIterator[nullable Object, nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 806);
fatal_exit(1);
}
{
...
val* core___core__SequenceRead____91d_93d(val* self, long p0) {
val* var /* : nullable Object */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 810);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#SequenceRead#modulo for (self: SequenceRead[nullable Object], Int): nullable Object */
val* core___core__SequenceRead___modulo(val* self, long p0) {
val* var /* : nullable Object */;
...
var_index = p0;
{
var1 = ((long(*)(val* self, long p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead__modulo_index]))(self, var_index); /* modulo_index on <self:SequenceRead[nullable Object]>*/
}
{
var2 = ((val*(*)(val* self, long p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead___91d_93d]))(self, var1); /* [] on <self:SequenceRead[nullable Object]>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
/* method abstract_collection#SequenceRead#modulo_index for (self: SequenceRead[nullable Object], Int): Int */
long core___core__SequenceRead___modulo_index(val* self, long p0) {
long var /* : Int */;
long var_index /* var index: Int */;
long var1 /* : Int */;
...
if (var2){
{
{ /* Inline kernel#Int#% (var_index,var_length) on <var_index:Int> */
var8 = var_index % var_length;
var6 = var8;
goto RET_LABEL7;
RET_LABEL7:(void)0;
}
...
{
{ /* Inline kernel#Int#- (var9,var_index) on <var9:Int> */
/* Covariant cast for argument 0 (i) <var_index:Int> isa OTHER */
/* <var_index:Int> isa OTHER */
var14 = 1; /* easy <var_index:Int> isa OTHER*/
if (unlikely(!var14)) {
...
{
{ /* Inline kernel#Int#% (var12,var_length) on <var12:Int> */
var21 = var12 % var_length;
var19 = var21;
goto RET_LABEL20;
RET_LABEL20:(void)0;
}
...
{
{ /* Inline kernel#Int#- (var_length,var19) on <var_length:Int> */
...
if (unlikely(!var2)) {
PRINT_ERROR("Runtime error: %s", "Assert \'not_empty\' failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 869);
fatal_exit(1);
}
{
...
val* core___core__SequenceRead___Collection__iterator(val* self) {
val* var /* : IndexedIterator[nullable Object] */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "iterator", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 963);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 979);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1006);
fatal_exit(1);
}
var_item = p0;
{
...
void core___core__Sequence___last_61d(val* self, val* p0) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1015);
fatal_exit(1);
}
var_item = p0;
{
var1 = ((long(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Collection__length]))(self); /* length on <self:Sequence[nullable Object]>*/
}
var_l = var1;
{
{ /* Inline kernel#Int#> (var_l,0l) on <var_l:Int> */
...
{
((void(*)(val* self, long p0, val* p1))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, var9, var_item); /* []= on <self:Sequence[nullable Object]>*/
}
} else {
{
((void(*)(val* self, long p0, val* p1))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, 0l, var_item); /* []= on <self:Sequence[nullable Object]>*/
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1037);
fatal_exit(1);
}
var_e = p0;
{
...
void core___core__Sequence___push(val* self, val* p0) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "push", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1040);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Collection[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1048);
fatal_exit(1);
}
var_coll = p0;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1057);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1067);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Collection[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1075);
fatal_exit(1);
}
var_coll = p0;
{
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1084);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method abstract_collection#Sequence#[]= for (self: Sequence[nullable Object], Int, nullable Object) */
void core___core__Sequence____91d_93d_61d(val* self, long p0, val* p1) {
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "[]=", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1095);
fatal_exit(1);
RET_LABEL:;
}
/* method abstract_collection#Sequence#modulo= for (self: Sequence[nullable Object], Int, nullable Object) */
void core___core__Sequence___modulo_61d(val* self, long p0, val* p1) {
short int var /* : Bool */;
int cltype;
int idtype;
const struct type* type_struct;
...
long var1 /* : Int */;
/* Covariant cast for argument 1 (value) <p1:nullable Object> isa E */
...
var_class_name = p1 == NULL ? "null" : (((long)p1&3)?type_info[((long)p1&3)]:p1->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "E", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1110);
fatal_exit(1);
}
var_index = p0;
var_value = p1;
{
var1 = ((long(*)(val* self, long p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__SequenceRead__modulo_index]))(self, var_index); /* modulo_index on <self:Sequence[nullable Object]>*/
}
{
((void(*)(val* self, long p0, val* p1))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__Sequence___91d_93d_61d]))(self, var1, var_value); /* []= on <self:Sequence[nullable Object]>*/
}
RET_LABEL:;
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1128);
fatal_exit(1);
RET_LABEL:;
}
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "Collection[E]", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1138);
fatal_exit(1);
}
var_coll = p0;
var_index = p1;
...
if (unlikely(!var1)) {
PRINT_ERROR("Runtime error: %s", "Assert failed");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1148);
fatal_exit(1);
}
{
...
val* core___core__CoupleMap___couple_at(val* self, val* p0) {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1180);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
val* core___core__CoupleMap___couple_iterator(val* self) {
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1184);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
{
var2 = ((val*(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__CoupleMap__couple_iterator]))(self); /* couple_iterator on <self:CoupleMap[nullable Object, nullable Object]>*/
}
{
...
val* core___core__CoupleMap___MapRead___91d_93d(val* self, val* p0) {
val* var /* : nullable Object */;
val* var_key /* var key: nullable Object */;
...
var_key = p0;
{
var1 = ((val*(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__CoupleMap__couple_at]))(self, var_key); /* couple_at on <self:CoupleMap[nullable Object, nullable Object]>*/
}
var_c = var1;
if (var_c == NULL) {
var2 = 1; /* is null */
...
if (0) {
var3 = ((short int(*)(val* self, val* p0))(var_c->class->vft[COLOR_core__kernel__Object___61d_61d]))(var_c, ((val*)NULL)); /* == on <var_c:nullable Couple[nullable Object, nullable Object]>*/
var2 = var3;
}
if (var2){
{
var4 = ((val*(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__abstract_collection__MapRead__provide_default_value]))(self, var_key); /* provide_default_value on <self:CoupleMap[nullable Object, nullable Object]>*/
}
var = var4;
goto RET_LABEL;
} else {
{
var5 = ((val*(*)(val* self))(var_c->class->vft[COLOR_core__abstract_collection__Couple__second]))(var_c); /* second on <var_c:nullable Couple[nullable Object, nullable Object](Couple[nullable Object, nullable Object])>*/
}
var = var5;
goto RET_LABEL;
}
...
if (0) {
var3 = ((short int(*)(val* self, val* p0))(var1->class->vft[COLOR_core__kernel__Object___33d_61d]))(var1, ((val*)NULL)); /* != on <var1:nullable Couple[nullable Object, nullable Object]>*/
var2 = var3;
}
var = var2;
goto RET_LABEL;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1208);
fatal_exit(1);
}
{
...
{
var3 = ((val*(*)(val* self))(var2->class->vft[COLOR_core__abstract_collection__Couple__second]))(var2); /* second on <var2:nullable Object(Couple[nullable Object, nullable Object])>*/
}
var = var3;
goto RET_LABEL;
RET_LABEL:;
...
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _iter");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1212);
fatal_exit(1);
}
{
var2 = ((val*(*)(val* self))((((long)var1&3)?class_info[((long)var1&3)]:var1->class)->vft[COLOR_core__abstract_collection__Iterator__item]))(var1); /* item on <var1:Iterator[Couple[nullable Object, nullable Object]]>*/
...
{
var3 = ((val*(*)(val* self))(var2->class->vft[COLOR_core__abstract_collection__Couple__first]))(var2); /* first on <var2:nullable Object(Couple[nullable Object, nullable Object])>*/
}
var = var3;
goto RET_LABEL;
RET_LABEL:;
...
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _iter");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1218);
fatal_exit(1);
}
{
...
val* core__abstract_collection___core__abstract_collection__CoupleMapIterator___iter(val* self) {
val* var /* : Iterator[Couple[nullable Object, nullable Object]] */;
val* var1 /* : Iterator[Couple[nullable Object, nullable Object]] */;
var1 = self->attrs[COLOR_core__abstract_collection__CoupleMapIterator___iter].val; /* _iter on <self:CoupleMapIterator[nullable Object, nullable Object]> */
if (unlikely(var1 == NULL)) {
PRINT_ERROR("Runtime error: %s", "Uninitialized attribute _iter");
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1221);
fatal_exit(1);
}
var = var1;
RET_LABEL:;
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1229);
fatal_exit(1);
}
...
PRINT_ERROR(" (%s:%d)\n", FILE_core__abstract_collection, 1232);
fatal_exit(1);
}
