...
void core___core__Object___output(val* self) {
long var /* : Int */;
core___core__Char___Object__output('<'); /* Direct call kernel#Char#output on <'<':Char>*/
{
var = ((long(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Object__object_id]))(self); /* object_id on <self:Object>*/
}
{
...
void core___core__Object___output_class_name(val* self) {
...
void core___core__Sys___main(val* self) {
RET_LABEL:;
}
/* method kernel#Sys#run for (self: Sys) */
void core___core__Sys___run(val* self) {
{
((void(*)(val* self))(self->class->vft[COLOR_core__kernel__Sys__main]))(self); /* main on <self:Sys>*/
}
RET_LABEL:;
}
...
short int core___core__Comparable____60d(val* self, val* p0) {
short int var /* : Bool */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "<", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 319);
fatal_exit(1);
RET_LABEL:;
return var;
}
...
short int core___core__Comparable___is_between(val* self, val* p0, val* p1) {
short int var /* : Bool */;
short int var1 /* : Bool */;
int cltype;
int idtype;
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 346);
fatal_exit(1);
}
/* Covariant cast for argument 1 (d) <p1:Comparable> isa OTHER */
/* <p1:Comparable> isa OTHER */
type_struct5 = (((long)self&3)?type_info[((long)self&3)]:self->type)->resolution_table->types[COLOR_core__kernel__Comparable__OTHER];
...
var_d = p1;
{
var8 = ((short int(*)(val* self, val* p0))((((long)var_c&3)?class_info[((long)var_c&3)]:var_c->class)->vft[COLOR_core__kernel__Comparable___60d_61d]))(var_c, self); /* <= on <var_c:Comparable>*/
}
var_ = var8;
if (var8){
{
var9 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Comparable___60d_61d]))(self, var_d); /* <= on <self:Comparable>*/
}
var7 = var9;
} else {
var7 = var_;
...
var_class_name = p0 == NULL ? "null" : (((long)p0&3)?type_info[((long)p0&3)]:p0->type)->name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 385);
fatal_exit(1);
}
var_d = p0;
{
var2 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Comparable___60d]))(self, var_d); /* < on <self:Discrete>*/
}
if (var2){
...
{
var8 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Comparable___62d]))(self, var_d); /* > on <self:Discrete>*/
}
if (var8){
var_cursor = var_d;
/* <self:Discrete> isa OTHER */
type_struct12 = (((long)self&3)?type_info[((long)self&3)]:self->type)->resolution_table->types[COLOR_core__kernel__Comparable__OTHER];
...
for(;;) {
{
var14 = ((short int(*)(val* self, val* p0))((((long)var_cursor&3)?class_info[((long)var_cursor&3)]:var_cursor->class)->vft[COLOR_core__kernel__Comparable___60d]))(var_cursor, var_stop); /* < on <var_cursor:Discrete>*/
}
if (var14){
{
var15 = ((val*(*)(val* self, long p0))((((long)var_cursor&3)?class_info[((long)var_cursor&3)]:var_cursor->class)->vft[COLOR_core__kernel__Discrete__successor]))(var_cursor, 1l); /* successor on <var_cursor:Discrete>*/
}
/* <var15:Discrete> isa OTHER */
type_struct19 = (((long)self&3)?type_info[((long)self&3)]:self->type)->resolution_table->types[COLOR_core__kernel__Comparable__OTHER];
...
val* core___core__Cloneable___clone(val* self) {
val* var /* : Cloneable */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "clone", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 417);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#+ for (self: Numeric, Numeric): Numeric */
val* core___core__Numeric____43d(val* self, val* p0) {
val* var /* : Numeric */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "+", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 437);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#- for (self: Numeric, Numeric): Numeric */
val* core___core__Numeric____45d(val* self, val* p0) {
val* var /* : Numeric */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "-", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 440);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#unary - for (self: Numeric): Numeric */
val* core___core__Numeric___unary_32d_45d(val* self) {
val* var /* : Numeric */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "unary -", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 443);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#* for (self: Numeric, Numeric): Numeric */
val* core___core__Numeric____42d(val* self, val* p0) {
val* var /* : Numeric */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "*", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 446);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#/ for (self: Numeric, Numeric): Numeric */
val* core___core__Numeric____47d(val* self, val* p0) {
val* var /* : Numeric */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "/", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 449);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#to_i for (self: Numeric): Int */
long core___core__Numeric___to_i(val* self) {
long var /* : Int */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "to_i", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 452);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#to_f for (self: Numeric): Float */
double core___core__Numeric___to_f(val* self) {
double var /* : Float */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "to_f", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 461);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#to_b for (self: Numeric): Byte */
unsigned char core___core__Numeric___to_b(val* self) {
unsigned char var /* : Byte */;
const char* var_class_name;
var_class_name = self == NULL ? "null" : (((long)self&3)?type_info[((long)self&3)]:self->type)->name;
PRINT_ERROR("Runtime error: Abstract method `%s` called on `%s`", "to_b", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 467);
fatal_exit(1);
RET_LABEL:;
return var;
}
/* method kernel#Numeric#is_zero for (self: Numeric): Bool */
short int core___core__Numeric___is_zero(val* self) {
short int var /* : Bool */;
val* var1 /* : Numeric */;
short int var2 /* : Bool */;
{
var1 = ((val*(*)(val* self))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Numeric__zero]))(self); /* zero on <self:Numeric>*/
}
{
var2 = ((short int(*)(val* self, val* p0))((((long)self&3)?class_info[((long)self&3)]:self->class)->vft[COLOR_core__kernel__Object___61d_61d]))(self, var1); /* == on <self:Numeric>*/
}
var = var2;
goto RET_LABEL;
RET_LABEL:;
...
void core___core__Bool___Object__output(short int self) {
printf(self?"true\n":"false\n");
RET_LABEL:;
}
/* method kernel#Bool#output for (self: Object) */
void VIRTUAL_core___core__Bool___Object__output(val* self) {
short int var /* : Bool */;
...
void core___core__Float___Object__output(double self) {
printf("%f\n", self);
RET_LABEL:;
}
/* method kernel#Float#output for (self: Object) */
void VIRTUAL_core___core__Float___Object__output(val* self) {
double var /* : Float */;
{ /* Inline kernel#Float#output (self) on <self:Object(Float)> */
var = ((struct instance_core__Float*)self)->value; /* autounbox from Object to Float */;
printf("%f\n", var);
RET_LABEL1:(void)0;
}
RET_LABEL:;
...
val* var3 /* : Numeric */;
var2 = ((struct instance_core__Float*)self)->value; /* autounbox from Numeric to Float */;
var1 = core___core__Float___Numeric__zero(var2);
var3 = BOX_core__Float(var1); /* autobox from Float to Numeric */
var = var3;
RET_LABEL:;
return var;
}
...
var_val = p0;
{
var1 = ((double(*)(val* self))((((long)var_val&3)?class_info[((long)var_val&3)]:var_val->class)->vft[COLOR_core__kernel__Numeric__to_f]))(var_val); /* to_f on <var_val:Numeric>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
val* VIRTUAL_core___core__Float___Numeric__value_of(val* self, val* p0) {
val* var /* : Numeric */;
double var1 /* : Float */;
double var2 /* : Float */;
val* var3 /* : Numeric */;
var2 = ((struct instance_core__Float*)self)->value; /* autounbox from Numeric to Float */;
var1 = core___core__Float___Numeric__value_of(var2, p0);
var3 = BOX_core__Float(var1); /* autobox from Float to Numeric */
var = var3;
RET_LABEL:;
return var;
...
if (unlikely(!var2)) {
var_class_name5 = type_core__Float.name;
...
short int VIRTUAL_core___core__Float___Comparable__is_between(val* self, val* p0, val* p1) {
short int var /* : Bool */;
short int var1 /* : Bool */;
double var2 /* : Float */;
double var3 /* : Float */;
...
var2 = ((struct instance_core__Float*)self)->value; /* autounbox from Comparable to Float */;
var3 = ((struct instance_core__Float*)p0)->value; /* autounbox from Comparable to Float */;
var4 = ((struct instance_core__Float*)p1)->value; /* autounbox from Comparable to Float */;
var1 = core___core__Float___Comparable__is_between(var2, var3, var4);
var = var1;
RET_LABEL:;
return var;
}
/* method kernel#Float#is_approx for (self: Float, Float, Float): Bool */
short int core___core__Float___is_approx(double self, double p0, double p1) {
short int var /* : Bool */;
double var_other /* var other: Float */;
...
/* method kernel#Byte#predecessor for (self: Byte, Int): Byte */
...
/* method kernel#Byte#predecessor for (self: Discrete, Int): Discrete */
...
val* var3 /* : Discrete */;
var2 = ((struct instance_core__Byte*)self)->value; /* autounbox from Discrete to Byte */;
var1 = core___core__Byte___Discrete__predecessor(var2, p0);
var3 = BOX_core__Byte(var1); /* autobox from Byte to Discrete */
var = var3;
RET_LABEL:;
return var;
...
/* method kernel#Byte#output for (self: Byte) */
void core___core__Byte___Object__output(unsigned char self) {
printf("%x\n", self);
RET_LABEL:;
}
/* method kernel#Byte#output for (self: Object) */
void VIRTUAL_core___core__Byte___Object__output(val* self) {
unsigned char var /* : Byte */;
{ /* Inline kernel#Byte#output (self) on <self:Object(Byte)> */
var = ((struct instance_core__Byte*)self)->value; /* autounbox from Object to Byte */;
printf("%x\n", var);
RET_LABEL1:(void)0;
}
RET_LABEL:;
...
/* method kernel#Byte#% for (self: Byte, Byte): Byte */
unsigned char core___core__Byte____37d(unsigned char self, unsigned char p0) {
unsigned char var /* : Byte */;
unsigned char var1 /* : Byte */;
var1 = self % p0;
var = var1;
...
/* method kernel#Byte#zero for (self: Byte): Byte */
unsigned char core___core__Byte___Numeric__zero(unsigned char self) {
unsigned char var /* : Byte */;
unsigned char var1 /* : Byte */;
unsigned char var3 /* : Byte */;
{
{ /* Inline kernel#Int#to_b (0l) on <0l:Int> */
var3 = (unsigned char)0l;
var1 = var3;
goto RET_LABEL2;
RET_LABEL2:(void)0;
}
...
/* method kernel#Byte#zero for (self: Numeric): Numeric */
...
var1 = core___core__Byte___Numeric__zero(var2);
var3 = BOX_core__Byte(var1); /* autobox from Byte to Numeric */
var = var3;
RET_LABEL:;
return var;
}
/* method kernel#Byte#value_of for (self: Byte, Numeric): Byte */
...
var_val = p0;
{
var1 = ((unsigned char(*)(val* self))((((long)var_val&3)?class_info[((long)var_val&3)]:var_val->class)->vft[COLOR_core__kernel__Numeric__to_b]))(var_val); /* to_b on <var_val:Numeric>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
/* method kernel#Byte#value_of for (self: Numeric, Numeric): Numeric */
val* VIRTUAL_core___core__Byte___Numeric__value_of(val* self, val* p0) {
val* var /* : Numeric */;
unsigned char var1 /* : Byte */;
unsigned char var2 /* : Byte */;
val* var3 /* : Numeric */;
var2 = ((struct instance_core__Byte*)self)->value; /* autounbox from Numeric to Byte */;
var1 = core___core__Byte___Numeric__value_of(var2, p0);
var3 = BOX_core__Byte(var1); /* autobox from Byte to Numeric */
var = var3;
RET_LABEL:;
return var;
...
unsigned char core___core__Byte____60d_60d(unsigned char self, long p0) {
unsigned char var /* : Byte */;
unsigned char var1 /* : Byte */;
var1 = self << p0;
var = var1;
...
/* method kernel#Byte#is_between for (self: Byte, Byte, Byte): Bool */
...
unsigned char var_d /* var d: Byte */;
short int var6 /* : Bool */;
short int var7 /* : Bool */;
short int var9 /* : Bool */;
int cltype10;
...
var_class_name = type_core__Byte.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 676);
fatal_exit(1);
}
/* Covariant cast for argument 1 (d) <p1:Byte> isa OTHER */
/* <p1:Byte> isa OTHER */
var2 = 1; /* easy <p1:Byte> isa OTHER*/
if (unlikely(!var2)) {
var_class_name5 = type_core__Byte.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name5);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 676);
fatal_exit(1);
}
...
var_d = p1;
{
{ /* Inline kernel#Byte#< (self,var_c) on <self:Byte> */
/* Covariant cast for argument 0 (i) <var_c:Byte> isa OTHER */
/* <var_c:Byte> isa OTHER */
var9 = 1; /* easy <var_c:Byte> isa OTHER*/
if (unlikely(!var9)) {
var_class_name12 = type_core__Byte.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name12);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 619);
fatal_exit(1);
}
...
{
{ /* Inline kernel#Byte#< (var_d,self) on <var_d:Byte> */
/* Covariant cast for argument 0 (i) <self:Byte> isa OTHER */
/* <self:Byte> isa OTHER */
var16 = 1; /* easy <self:Byte> isa OTHER*/
if (unlikely(!var16)) {
var_class_name19 = type_core__Byte.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name19);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 619);
fatal_exit(1);
}
...
/* method kernel#Byte#is_between for (self: Comparable, Comparable, Comparable): Bool */
short int VIRTUAL_core___core__Byte___Comparable__is_between(val* self, val* p0, val* p1) {
short int var /* : Bool */;
short int var1 /* : Bool */;
unsigned char var2 /* : Byte */;
unsigned char var3 /* : Byte */;
...
var2 = ((struct instance_core__Byte*)self)->value; /* autounbox from Comparable to Byte */;
var3 = ((struct instance_core__Byte*)p0)->value; /* autounbox from Comparable to Byte */;
var4 = ((struct instance_core__Byte*)p1)->value; /* autounbox from Comparable to Byte */;
var1 = core___core__Byte___Comparable__is_between(var2, var3, var4);
var = var1;
RET_LABEL:;
return var;
}
...
val* var3 /* : Discrete */;
var2 = (long)(self)>>2;
var1 = core___core__Int___Discrete__predecessor(var2, p0);
var3 = (val*)(var1<<2|1);
var = var3;
RET_LABEL:;
return var;
...
void core___core__Int___Object__output(long self) {
printf("%ld\n", self);
RET_LABEL:;
}
/* method kernel#Int#output for (self: Object) */
void VIRTUAL_core___core__Int___Object__output(val* self) {
long var /* : Int */;
...
val* var3 /* : Numeric */;
var2 = (long)(self)>>2;
var1 = core___core__Int___Numeric__zero(var2);
var3 = (val*)(var1<<2|1);
var = var3;
RET_LABEL:;
return var;
...
var_val = p0;
{
var1 = ((long(*)(val* self))((((long)var_val&3)?class_info[((long)var_val&3)]:var_val->class)->vft[COLOR_core__kernel__Numeric__to_i]))(var_val); /* to_i on <var_val:Numeric>*/
}
var = var1;
goto RET_LABEL;
RET_LABEL:;
...
val* VIRTUAL_core___core__Int___Numeric__value_of(val* self, val* p0) {
val* var /* : Numeric */;
long var1 /* : Int */;
long var2 /* : Int */;
val* var3 /* : Numeric */;
var2 = (long)(self)>>2;
var1 = core___core__Int___Numeric__value_of(var2, p0);
var3 = (val*)(var1<<2|1);
var = var3;
RET_LABEL:;
return var;
...
if (unlikely(!var2)) {
var_class_name5 = type_core__Int.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name5);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 778);
fatal_exit(1);
}
...
short int VIRTUAL_core___core__Int___Comparable__is_between(val* self, val* p0, val* p1) {
short int var /* : Bool */;
short int var1 /* : Bool */;
long var2 /* : Int */;
long var3 /* : Int */;
...
var3 = (long)(p0)>>2;
var4 = (long)(p1)>>2;
var1 = core___core__Int___Comparable__is_between(var2, var3, var4);
var = var1;
RET_LABEL:;
return var;
}
...
core__kernel___Char_output___impl(self);
RET_LABEL:;
}
/* method kernel#Char#output for (self: Object) */
void VIRTUAL_core___core__Char___Object__output(val* self) {
uint32_t var /* : Char */;
var = (uint32_t)((long)(self)>>2);
core___core__Char___Object__output(var); /* Direct call kernel#Char#output on <var:Char>*/
RET_LABEL:;
}
...
uint32_t core___core__Char___Discrete__predecessor(uint32_t self, long p0) {
uint32_t var /* : Char */;
uint32_t var1 /* : Char */;
var1 = self - p0;
var = var1;
...
/* method kernel#Char#is_ascii for (self: Char): Bool */
short int core___core__Char___is_ascii(uint32_t self) {
short int var /* : Bool */;
long var1 /* : Int */;
long var3 /* : Int */;
short int var4 /* : Bool */;
...
{
{ /* Inline kernel#Int#<= (var1,127l) on <var1:Int> */
/* Covariant cast for argument 0 (i) <127l:Int> isa OTHER */
/* <127l:Int> isa OTHER */
var6 = 1; /* easy <127l:Int> isa OTHER*/
if (unlikely(!var6)) {
var_class_name = type_core__Int.name;
PRINT_ERROR("Runtime error: Cast failed. Expected `%s`, got `%s`", "OTHER", var_class_name);
PRINT_ERROR(" (%s:%d)\n", FILE_core__kernel, 721);
...
short int var_ /* var : Bool */;
short int var3 /* : Bool */;
var2 = core___core__Char___is_lower(self);
var_ = var2;
if (var2){
var1 = var_;
} else {
var3 = core___core__Char___is_upper(self);
var1 = var3;
}
var = var1;
goto RET_LABEL;
...
/* method kernel#Task#main for (self: Task) */
void core___core__Task___main(val* self) {
RET_LABEL:;
}
