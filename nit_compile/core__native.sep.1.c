...
/* method native#Int#from_utf16_surr for (self: Int): Int */
...
long var4 /* : Int */;
long var6 /* : Int */;
long var_hi /* var hi: Int */;
long var7 /* : Int */;
long var9 /* : Int */;
long var_lo /* var lo: Int */;
...
long var44 /* : Int */;
{
{ /* Inline math#Int#& (self,4294901760l) on <self:Int> */
var3 = self & 4294901760l;
var1 = var3;
goto RET_LABEL2;
RET_LABEL2:(void)0;
}
...
{
{ /* Inline kernel#Int#>> (var1,16l) on <var1:Int> */
var6 = var1 >> 16l;
var4 = var6;
goto RET_LABEL5;
RET_LABEL5:(void)0;
...
var_hi = var4;
{
{ /* Inline math#Int#& (self,65535l) on <self:Int> */
var9 = self & 65535l;
var7 = var9;
goto RET_LABEL8;
RET_LABEL8:(void)0;
...
var_cp = 0l;
{
{ /* Inline kernel#Int#- (var_hi,55296l) on <var_hi:Int> */
/* Covariant cast for argument 0 (i) <55296l:Int> isa OTHER */
/* <55296l:Int> isa OTHER */
var12 = 1; /* easy <55296l:Int> isa OTHER*/
if (unlikely(!var12)) {
...
{
{ /* Inline kernel#Int#<< (var10,10l) on <var10:Int> */
var16 = var10 << 10l;
var14 = var16;
goto RET_LABEL15;
RET_LABEL15:(void)0;
...
{
{ /* Inline kernel#Int#+ (var_cp,var14) on <var_cp:Int> */
...
var_cp = var17;
{
{ /* Inline kernel#Int#- (var_lo,56320l) on <var_lo:Int> */
/* Covariant cast for argument 0 (i) <56320l:Int> isa OTHER */
/* <56320l:Int> isa OTHER */
var26 = 1; /* easy <56320l:Int> isa OTHER*/
if (unlikely(!var26)) {
...
{
{ /* Inline kernel#Int#+ (var_cp,var24) on <var_cp:Int> */
...
var40 = 1; /* easy <65536l:Int> isa OTHER*/
if (unlikely(!var40)) {
...
/* method native#NativeString#fast_cstring for (self: NativeString, Int): NativeString */
char* core___core__NativeString___fast_cstring(char* self, long p0) {
char* var /* : NativeString */;
char* var1 /* : NativeString */;
var1 = self + p0;
var = var1;
...
/* method native#NativeString#atoi for (self: NativeString): Int */
long core___core__NativeString___atoi(char* self) {
long var /* : Int */;
long var1 /* : Int */;
var1 = atoi(self);;
var = var1;
...
/* method native#NativeString#byte_to_char_index_cached for (self: NativeString, Int, Int, Int): Int */
long core___core__NativeString___byte_to_char_index_cached(char* self, long p0, long p1, long p2) {
long var /* : Int */;
long var_n /* var n: Int */;
long var_char_from /* var char_from: Int */;
long var_byte_from /* var byte_from: Int */;
...
if (var1){
var5 = core___core__NativeString___length_of_char_at(self, var_ns_i);
{
...
var34 = core___core__NativeString___find_beginning_of_char_at(self, var27);
var_ns_i = var34;
{
{ /* Inline kernel#Int#- (var_my_i,1l) on <var_my_i:Int> */
/* Covariant cast for argument 0 (i) <1l:Int> isa OTHER */
